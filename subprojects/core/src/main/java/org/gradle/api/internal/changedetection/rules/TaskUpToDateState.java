...
public class TaskUpToDateState {
    ...
    public TaskUpToDateState(TaskExecution lastExecution, TaskExecution thisExecution, TaskInternal task) {
        ...
        TaskStateChanges inputPropertiesState = new SummaryTaskStateChanges(MAX_OUT_OF_DATE_MESSAGES, new InputPropertiesTaskStateChanges(lastExecution, thisExecution, task), inputFilePropertiesChanges);

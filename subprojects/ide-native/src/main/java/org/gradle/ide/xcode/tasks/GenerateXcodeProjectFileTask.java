...
public class GenerateXcodeProjectFileTask extends PropertyListGeneratorTask<XcodeProjectFile> {
    ...
    private PBXTarget toGradlePbxTarget(XcodeTarget xcodeTarget) {
        if (PBXTarget.ProductType.UNIT_TEST.equals(xcodeTarget.getProductType())) {
            ...
            testRunnerSettings.put("ALWAYS_SEARCH_USER_PATHS", "NO");
            testRunnerSettings.put("ASSETCATALOG_COMPILER_LAUNCHIMAGE_NAME", "Stub Launch Image");
            testRunnerSettings.put("MTL_ENABLE_DEBUG_INFO", "DEBUG");
